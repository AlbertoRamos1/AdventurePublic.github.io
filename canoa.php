...
<body>
    <!--Cabecera-->
    <header>
        <img class="img-fluid" src="./assets/img/cabecera_canoa.jpg" alt="canoa">
    </header>

    <section class="row mt-5 mb-4 text-center">

        <div class="col-12 col-lg-8">
            <img class="img-fluid" src="assets\img\canoa.jpg" alt="">
        </div>
        ...
        <div class="container text-center mt-3 px-5">
            <p>La canoa brinda una experiencia de navegación versátil, 
