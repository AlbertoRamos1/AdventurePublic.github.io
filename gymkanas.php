...
<body>
    <!--Cabecera-->
    <header>
        <img class="img-fluid" src="./assets/img/cabecera_gymkanas.jpg" alt="gymkanas">
    </header>
    ...
    <section class="row mt-5 mb-4 text-center">
        ...
        <div class="col-12 col-lg-8">
            <img class="img-fluid" src="assets\img\gymkanas.jpg" alt="">
        </div>
        ...
        <div class="container text-center mt-3 px-5">
            <p>Las gymkanas agregan un toque lúdico y competitivo a la actividad física, 
