...
<body>
    <!--Cabecera-->
    <header>
        <img class="img-fluid" src="./assets/img/cabecera_airsoft.jpg" alt="airsoft">
    </header>
    ...
    <section class="row mt-5 mb-4 text-center">
        ...
        <div class="col-12 col-lg-8">
            <img class="img-fluid" src="assets\img\airsoft.jpg" alt="">
        </div>
        ...
        <div class="container text-center mt-3 px-5">
            <p>Sumérgete en emocionantes batallas simuladas con el airsoft, 
