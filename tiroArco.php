...
<body>
    <!--Cabecera-->
    <header>
        <img class="img-fluid" src="./assets/img/cabecera_tiroArco.jpg" alt="tiro con arco">
    </header>
    ...
    <section class="row mt-5 mb-4 text-center">
        ...
        <div class="col-12 col-lg-8">
            <img class="img-fluid" src="assets\img\tiroArco.jpg" alt="">
        </div>
        ...
        <div class="container text-center mt-3 px-5">
            <p>La precisión y concentración se unen en el tiro con arco, 
