...
<body>
    <!--Cabecera-->
    <header>
        <img class="img-fluid" src="./assets/img/cabecera_alpinismo.jpg" alt="alpinismo">
    </header>

    <section class="row mt-5 mb-4 text-center">

        <div class="col-12 col-lg-8">
            <img class="img-fluid" src="assets\img\alpinismo.jpg" alt="">
        </div>
        ...
        <div class="container text-center mt-3 px-5">
            <p>El alpinismo es la conquista de altas cumbres y paisajes majestuosos. 
