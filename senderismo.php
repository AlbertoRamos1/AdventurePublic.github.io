...
<body>
    <!--Cabecera-->
    <header>
        <img class="img-fluid" src="./assets/img/cabecera_senderismo.jpg" alt="senderismo">
    </header>
    ...
    <section class="row mt-5 mb-4 text-center">
        ...
        <div class="col-12 col-lg-8">
            <img class="img-fluid" src="assets\img\senderismo.jpg" alt="">
        </div>
        ...
        <div class="container text-center mt-3 px-5">
            <p>Descubre la belleza natural con el senderismo, 
