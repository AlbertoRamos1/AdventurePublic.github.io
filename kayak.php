...
<body>
    ...
    <!--Cabecera-->
    <header>
        <img class="img-fluid" src="./assets/img/cabecera_kayak.jpg" alt="kayak">
    </header>

    <section class="row mt-5 mb-4 text-center">

        <div class="col-12 col-lg-8">
            <img class="img-fluid" src="assets\img\kayakTarjetas.jpg" alt="">
        </div>
        ...
        <div class="container text-center mt-3 px-5">
            <p>Tanto para navegantes solitarios como para equipos, el 
