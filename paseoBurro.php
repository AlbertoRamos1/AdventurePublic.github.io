...
<body>
    <!--Cabecera-->
    <header>
        <img class="img-fluid" src="./assets/img/cabecera_paseoBurro.jpg" alt="paseo en burro">
    </header>
    ...
    <section class="row mt-5 mb-4 text-center">
        ...
        <div class="col-12 col-lg-8">
            <img class="img-fluid" src="assets\img\paseoBurro.jpg" alt="">
        </div>
        ...
        <div class="col-12 col-lg-3 border border-radius padding-carrito">
            ...
            <form action="finalizar.php" method="POST" class="row m-3">
                <button type="submit" class="button-generic1">Añadir</button>
            </form>
        </div>

        <div class="container text-center mt-3 px-5">
            <p>Con un encanto peculiar, el paseo en burro es una experiencia relajante 
