...
<body>
    <!--Cabecera-->
    <header>
        <img class="img-fluid" src="./assets/img/cabecera_rafting.jpg" alt="rafting">
    </header>

    <section class="row mt-5 mb-4 text-center">

        <div class="col-12 col-lg-8">
            <img class="img-fluid" src="assets\img\rafting.jpg" alt="">
        </div>
        ...
        <div class="container text-center mt-3 px-5">
            <p>El rafting es una emocionante aventura acuática que implica 
